...
namespace Praca_mgr
{
    public partial class FormParametrProdukt : Form
    {
        ...
        public FormParametrProdukt(Firma_produkcyjnaEntities db)
        {
            InitializeComponent();
            this.db = db;
        ...
        private void initDataGridViewParametrProdukt()
        {
            ...
            dgvRodzajParametr.Columns["Parametr_poziom_magazynowanie"].Visible = false;
            dgvRodzajParametr.Columns["Parametr_typ_magazynowania"].Visible = false;
        ...
        {
            FormDodajParametr dodajParametr = new FormDodajParametr(db);
