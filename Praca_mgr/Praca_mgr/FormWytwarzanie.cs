...
namespace Praca_mgr
{
    public partial class FormWytwarzanie : Form
    {
        ...
        public FormWytwarzanie(Firma_produkcyjnaEntities db)
        {
            InitializeComponent();
            this.db = db;
            refreshComboboxes();
        ...
        private void btnAkceptuj_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (vProduktIdInt > 0)
                {
                    ...
                    dgvProcesProdukt.Columns["ID_proces_produkt"].Visible = false;                    
                ...
                if (vProduktIdInt > 0)
                {
                    ...
                    dgvProcesPolprodukt.Columns["ID_proces_polprodukt"].Visible = false;
