...
namespace Praca_mgr
{
    public partial class FormSkladProdukt : Form
    {
        ...
        public FormSkladProdukt(Firma_produkcyjnaEntities db)
        {
            InitializeComponent();
            this.db = db;
        ...
        private void initDataGridViewPolprodukt()
        {
            ...
            dgvPolprodukt.Columns["Miejsce_magazynowanie_polprodukt"].Visible = false;
            dgvPolprodukt.Columns["Szczegoly_zamowienie_polprodukt"].Visible = false;
        }
        ...
        private void initDataGridViewSkladProdukt()
        {
            ...
            dgvSkladProdukt.Columns["ID_produkt"].Visible = false;
            dgvSkladProdukt.Columns["ID_polprodukt"].Visible = false;
        ...
        private void btnDodaj_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                skladProdukt.Ilosc = int.Parse(txtIlosc.Text);
