...
namespace Praca_mgr
{ 
    public partial class FormDodajParametr : Form
    {
        Firma_produkcyjnaEntities db;
        public FormDodajParametr(Firma_produkcyjnaEntities db)
        {
            InitializeComponent();
            this.db = db;
        ...
        {
            FormDodajJednostka dodajJednostka = new FormDodajJednostka(db);
