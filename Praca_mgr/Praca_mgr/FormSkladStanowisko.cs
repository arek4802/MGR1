...
namespace Praca_mgr
{
    public partial class FormSkladStanowisko : Form
    {
        ...
        public FormSkladStanowisko(Firma_produkcyjnaEntities db)
        {
            InitializeComponent();
            this.db = db;
            refreshScreen();
        ...
        private void btnDodajStanowisko_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    skladStanowisko.Ilosc = int.Parse(txtIlosc.Text);
        ...
        {
            FormSlownikStanowisko slownikStanowisko = new FormSlownikStanowisko(db);
            slownikStanowisko.ShowDialog();
        }
